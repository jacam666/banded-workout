        ...
        <div className='shoulders-container'>
            ...
            <div className='card-container row justify-content-evenly' >
                ...
                <div className='col-lg-2 col-md-4 col-sm-6'>
                    <div className="d-flex flex-column h-100">
                        <Card className="flex-fill" style={{ opacity: 0.9 }}>
                            <Card.Img className='shoulder-images' variant="top" src="/images/Shoulders/shoulders delt front raise.png" />
                            <Card.Body>
                                <Card.Title>Delt Front Raise</Card.Title>
                                <Card.Text>
                ...
                <div className='col-lg-2 col-md-4 col-sm-6'>
                    <div className="d-flex flex-column h-100">
                        <Card className="flex-fill" style={{ opacity: 0.9 }}>
                            <Card.Img className='shoulder-images' variant="top" src="/images/Shoulders/shoulders lateral raises.png" />
                            <Card.Body>
